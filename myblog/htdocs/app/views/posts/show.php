                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" name="title" placeholder="Title" disabled class="form-control form-control-lg
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="short_content" placeholder="Short Content" row="4" disabled  class="form-control form-control-lg
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="full_content" placeholder="Full Content" row="10" disabled  class="form-control form-control-lg
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" name="image" placeholder="Image Url" disabled  class="form-control form-control-lg
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="category_id" class="form-control form-control-lg" disabled >
