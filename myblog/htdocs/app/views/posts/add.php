                    ...
                    <form id="form" action="" method="post" class="form-horizontal">
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="full_content" placeholder="Full Content" row="4" class="form-control form-control-lg
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" name="image" placeholder="Image Url" row="4" class="form-control form-control-lg
